...
%struct.hart_return_type = type { %"struct.ap_int<32>", %"struct.ap_uint<1>" }
...
declare void @apatb_hart_hw(%struct.hart_return_type*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*)
...
define void @hart_hw_stub_wrapper(%struct.hart_return_type*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*) #2 {
entry:
  call void @copy_out()
  call void @hart_hw_stub(%struct.hart_return_type* %0, %"struct.ap_int<32>"* %1, %"struct.ap_int<32>"* %2)
  call void @copy_in()
  ret void
}

declare void @hart_hw_stub(%struct.hart_return_type*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*)

; Function Attrs: noinline
define void @apatb_hart_ir(i64* %ret, %"struct.ap_int<32>"* nocapture readonly %inst, %"struct.ap_int<32>"* nocapture readonly %pc) #3 {
entry:
  call fastcc void @copy_in()
  %0 = alloca %struct.hart_return_type
  call void @apatb_hart_hw(%struct.hart_return_type* %0, %"struct.ap_int<32>"* %inst, %"struct.ap_int<32>"* %pc)
  %1 = load volatile %struct.hart_return_type, %struct.hart_return_type* %0
  call void @copy_back()
  %2 = bitcast %struct.hart_return_type* %0 to i64*
