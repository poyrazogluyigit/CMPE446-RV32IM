; ModuleID = 'E:/assignment/assignment/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%struct.arith_type = type { %"struct.ap_int<32>", %"struct.ap_uint<1>" }
...
declare void @apatb_hart_hw(%struct.arith_type*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*)
...
define void @hart_hw_stub_wrapper(%struct.arith_type*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*) #2 {
entry:
  call void @copy_out()
  call void @hart_hw_stub(%struct.arith_type* %0, %"struct.ap_int<32>"* %1, %"struct.ap_int<32>"* %2)
  call void @copy_in()
  ret void
}

declare void @hart_hw_stub(%struct.arith_type*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*)

; Function Attrs: noinline willreturn
define void @apatb_hart_ir(%struct.arith_type* %ret, %"struct.ap_int<32>"* nocapture readonly %inst, %"struct.ap_int<32>"* nocapture readonly %pc) #3 {
entry:
  call fastcc void @copy_in()
  %0 = alloca %struct.arith_type
  call void @apatb_hart_hw(%struct.arith_type* %0, %"struct.ap_int<32>"* %inst, %"struct.ap_int<32>"* %pc)
  %1 = load volatile %struct.arith_type, %struct.arith_type* %0
  call void @copy_back()
  %2 = load volatile %struct.arith_type, %struct.arith_type* %0
  store %struct.arith_type %2, %struct.arith_type* %ret
  ret void
}
