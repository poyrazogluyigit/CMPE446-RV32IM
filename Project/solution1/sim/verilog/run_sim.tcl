...
if {[file isfile top_module.autotvin.dat]} {
	file delete -force top_module.autotvin.dat
}

if {[file isfile top_module.autotvout.dat]} {
	file delete -force top_module.autotvout.dat
}
