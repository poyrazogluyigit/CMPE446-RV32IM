; ModuleID = '/home/omer.erzurumluoglu/Desktop/CMPE446-RV32IM/Project/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%struct.superscalar_type = type { %"struct.ap_int<32>", %"struct.ap_uint<1>", %"struct.ap_uint<1>" }
...
declare void @apatb_top_module_hw(%struct.superscalar_type*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*)
...
define void @top_module_hw_stub_wrapper(%struct.superscalar_type*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*) #2 {
entry:
  call void @copy_out()
  call void @top_module_hw_stub(%struct.superscalar_type* %0, %"struct.ap_int<32>"* %1, %"struct.ap_int<32>"* %2, %"struct.ap_int<32>"* %3)
  call void @copy_in()
  ret void
}

declare void @top_module_hw_stub(%struct.superscalar_type*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*, %"struct.ap_int<32>"*)

; Function Attrs: noinline
define void @apatb_top_module_ir(i64* %ret, %"struct.ap_int<32>"* nocapture readonly %pc, %"struct.ap_int<32>"* nocapture readonly %inst1, %"struct.ap_int<32>"* nocapture readonly %inst2) #3 {
entry:
  call fastcc void @copy_in()
  %0 = alloca %struct.superscalar_type
  call void @apatb_top_module_hw(%struct.superscalar_type* %0, %"struct.ap_int<32>"* %pc, %"struct.ap_int<32>"* %inst1, %"struct.ap_int<32>"* %inst2)
  %1 = load volatile %struct.superscalar_type, %struct.superscalar_type* %0
  call void @copy_back()
  %2 = bitcast %struct.superscalar_type* %0 to i64*
