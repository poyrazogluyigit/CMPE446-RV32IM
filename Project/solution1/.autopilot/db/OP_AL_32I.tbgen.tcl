...
set C_modelArgMapList {[ 
	{ "Name" : "opcode_val", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ opcode_val sc_in sc_lv 7 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "opcode_val", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "opcode_val", "role": "default" }} , 
...
set Spec2ImplPortList { 
	opcode_val { ap_none {  { opcode_val in_data 0 7 } } }
