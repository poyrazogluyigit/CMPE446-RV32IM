...
HLS_SOURCES = ../../../../test_hart.cpp ../../../../OP_AL_32I.cpp ../../../../OP_AL_B.cpp ../../../../hart.cpp ../../../../hazard_detector.cpp ../../../../top_module.cpp
...
$(ObjDir)/OP_AL_B.o: ../../../../OP_AL_B.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../OP_AL_B.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/OP_AL_B.d
...
$(ObjDir)/hazard_detector.o: ../../../../hazard_detector.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../hazard_detector.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/hazard_detector.d
